...
| ✅ | `python.unit.gen_vhdl` | Generate VHDL Modules | 0.006s |
...
| ✅ | `c.compile.headers` | Compile C Header Test | 0.150s |
| ✅ | `c.compile.run` | Run C Header Test Binary | 0.145s |
...
| ✅ | `vhdl.run.subregister_tb` | SUB-VHDL: Run subregister_test_tb Simulation | 0.315s |
...
| Status | Test ID | Test Name | Duration |
|:------:|:--------|:----------|:--------:|
| ✅ | `vhdl.analyze.sensor_controller` | Analyze sensor_controller.vhd | 0.079s |
| ✅ | `vhdl.analyze.spi_controller` | Analyze spi_controller.vhd | 0.045s |
| ✅ | `vhdl.analyze.mixed_width` | Analyze mixed_width_controller.vhd | 0.055s |
| ✅ | `vhdl.analyze.subregister_test` | SUB-VHDL: Analyze subregister_test.vhd | 0.043s |
| ✅ | `vhdl.analyze.subregister_axion` | SUB-VHDL: Analyze generated subregister_test_axion_reg.vhd | 0.152s |
| ✅ | `vhdl.analyze.subregister_tb` | SUB-VHDL: Analyze subregister_test_tb.vhd | 0.126s |
| ✅ | `vhdl.analyze.sensor_axion` | Analyze sensor_controller_axion_reg.vhd | 0.344s |
| ✅ | `vhdl.analyze.spi_axion` | Analyze spi_controller_axion_reg.vhd | 0.216s |
| ✅ | `vhdl.analyze.mixed_axion` | Analyze mixed_width_controller_axion_reg.vhd | 0.437s |
| ✅ | `vhdl.analyze.testbench` | Analyze multi_module_tb.vhd | 0.739s |
...
| Status | Test ID | Test Name | Duration |
|:------:|:--------|:----------|:--------:|
| ✅ | `vhdl.elaboration.subregister_tb` | SUB-VHDL: Elaborate subregister_test_tb | 0.261s |
...
| Status | Test ID | Test Name | Duration |
|:------:|:--------|:----------|:--------:|
| ✅ | `vhdl.elaborate.testbench` | Elaborate multi_module_tb | 0.073s |
...
| Status | Test ID | Test Name | Duration |
|:------:|:--------|:----------|:--------:|
| ✅ | `vhdl.xml.generate` | XML: Generate VHDL from tests/xml/subregister_test.xml | 0.008s |
| ✅ | `vhdl.xml.analyze_gen` | XML: Analyze generated subregister_test_xml_axion_reg.vhd | 0.223s |
| ✅ | `vhdl.xml.analyze_tb` | XML: Analyze subregister_xml_test_tb.vhd | 0.111s |
| ✅ | `vhdl.xml.elaborate` | XML: Elaborate subregister_xml_test_tb | 0.063s |
| ✅ | `vhdl.xml.run` | XML: Run subregister_xml_test_tb | 0.170s |
...
| ✅ | `gen.test_gen_001_vhdl_compiles` | GEN-001-VHDL-COMPILES: GEN-001: Generated VHDL compiles without errors | 0.387s |
...
| ✅ | `gen.test_gen_009_c_header_compiles` | GEN-009-C-HEADER-COMPILES: GEN-009: C header compiles without warnings | 0.260s |
...
| ✅ | `cli.test_cli_001_help_short_option` | CLI-001-HELP-SHORT-OPTION: CLI-001: -h displays usage information | 0.047s |
| ✅ | `cli.test_cli_002_version_option` | CLI-002-VERSION-OPTION: CLI-002: --version displays version | 0.043s |
| ✅ | `cli.test_cli_003_source_file_vhdl` | CLI-003-SOURCE-FILE-VHDL: CLI-003: -s accepts single VHDL file | 0.044s |
| ✅ | `cli.test_cli_003_source_file_xml` | CLI-003-SOURCE-FILE-XML: CLI-003: -s accepts single XML file | 0.052s |
| ✅ | `cli.test_cli_003_source_option_long` | CLI-003-SOURCE-OPTION-LONG: CLI-003: --source option specifies source directory | 0.059s |
| ✅ | `cli.test_cli_003_source_option_short` | CLI-003-SOURCE-OPTION-SHORT: CLI-003: -s option specifies source directory | 0.064s |
...
| ✅ | `cli.test_cli_005_output_option_long` | CLI-005-OUTPUT-OPTION-LONG: CLI-005: --output option specifies output directory | 0.097s |
| ✅ | `cli.test_cli_005_output_option_short` | CLI-005-OUTPUT-OPTION-SHORT: CLI-005: -o option specifies output directory | 0.092s |
| ✅ | `cli.test_cli_006_exclude_option` | CLI-006-EXCLUDE-OPTION: CLI-006: -e option excludes files/directories | 0.128s |
| ✅ | `cli.test_cli_009_invalid_source_error` | CLI-009-INVALID-SOURCE-ERROR: CLI-009: Non-existent source reports error | 0.041s |
| ✅ | `cli.test_cli_010_output_dir_creation` | CLI-010-OUTPUT-DIR-CREATION: CLI-010: Non-existent output directory is created | 0.118s |
...
| ✅ | `cdc.test_cdc_002_default_stage_count` | CDC-002-DEFAULT-STAGE-COUNT: CDC-002: CDC_EN without CDC_STAGE defaults to 2 stages | 0.003s |
...
---
*Generated by `make test` at 2025-12-09 23:23:45*