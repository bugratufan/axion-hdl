...
class DocGenerator:
    ...
    def generate_html(self, modules: List[Dict]) -> str:
        """Generate HTML documentation with embedded CSS styling."""
        output_path = os.path.join(self.output_dir, "register_map.html")
        ...
        full_html = self._wrap_html_with_style(html_content)
    ...
    def _wrap_html_with_style(self, content: str) -> str:
...
<head>
    ...
    <title>AXI Register Map Documentation</title>
    <style>
        :root {{
