...
class PythonGenerator:
    ...
    def generate(self, module_data: dict, output_dir: str = None) -> str:
        ...
        raw_name = module_data.get('name') or module_data.get('entity_name', 'unknown')
        entity_name = self._sanitize_identifier(raw_name)
...
#   base = {symbol_name}.base_address
#   {symbol_name}.write(base + 0x0000, 0x1)   # control register (offset 0x0000)
