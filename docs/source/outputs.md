...
An importable Python file that contains the register space as a live, simulation-ready
Python object. No re-parsing of YAML/VHDL sources is required — import the generated
file directly in your golden model.
...
| `WO` | Returns `0` (bus semantics) | Updates value |
...
| `--python`, `--py` | Python register model | Disabled |
