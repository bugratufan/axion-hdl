...
| HIER-007 | Single-instance output naming | When a module appears only once in the hierarchy, the output files keep the original module name (no suffix change). | Python Unit Test (`test_hier_007_single_instance_filename`) |
